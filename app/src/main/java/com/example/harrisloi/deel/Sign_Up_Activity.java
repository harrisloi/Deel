    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final ProgressDialog mdial = new ProgressDialog(Sign_Up_Activity.this);
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        && !edtFirstName.getText().toString().equals(null) && !edtFirstName.getText().toString().equals("") && !edtLastName.getText().toString().equals(null) && !edtLastName.getText().toString().equals("")
                            ...
                            if(dataSnapshot.child(edtUsername.getText().toString()).exists()){
                                mdial.dismiss();
                                Toast.makeText(Sign_Up_Activity.this,"Username has already registered.", Toast.LENGTH_SHORT).show();
                            }
                            else{
                            ...
                            Toast.makeText(Sign_Up_Activity.this,"Please make sure to fill all the information.", Toast.LENGTH_SHORT).show();
                            mdial.dismiss();
                        }
                    }
    ...
    public void validate(){
        if(checkEmail){
            if(checkPhoneNumber){
                ...
                Toast.makeText(Sign_Up_Activity.this,"Phone number has already registered.", Toast.LENGTH_SHORT).show();
            }
        }
        else {
            Toast.makeText(Sign_Up_Activity.this,"Email has already registered.", Toast.LENGTH_SHORT).show();
        }
    }
}
